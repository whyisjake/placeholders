...
Tags: blocks, gutenberg, ads, placeholder, wireframe
...
4. The blocks will appear in the "Placeholders" category.
...
4. Insert the block and customize colors using the block settings panel

= Can I customize the colors? =

Yes! Each block supports background and text color customization through the block settings panel.

= Can these blocks be used for actual ads? =
...
1. Placeholders category in the block inserter
2. Example of various ad placeholder sizes in the editor
...
= 1.0.0 =
Initial release of Placeholders plugin.
